...
export default function AboutPage() {
  return (
    <main className={`py-5 ${styles.futuristicWrap}`}>
      ...
      {/* Content */}
      <div className={`container ${styles.contentElevated}`}>
        <div className="row align-items-center g-4 g-lg-5">
          <div className="col-lg-7">
            ...
            <div className="row g-3">
              <div className="col-md-6">
                <div className={`p-3 h-100 border rounded-4 ${styles.glass}`}>
          ...
          <div className="col-lg-5">
            <div className={`p-4 border rounded-4 ${styles.glassCta}`}>
        ...
        <div className="row g-4">
          <div className="col-md-4">
            <div className={`p-4 h-100 border rounded-4 ${styles.glass}`}>
