      ...
      <div className="row align-items-center g-4 g-lg-5">
        <div className="col-lg-7">
          ...
          <p className="lead mb-4">
            ...
            เราให้ความสำคัญกับความเร็ว ความสวยงาม และความปลอดภัย เพื่อให้ผู้อ่านเข้าถึง��้อมูลที่ต้องการได้อย่างราบรื่น
          </p>
        ...
        <div className="col-lg-5">
          <div className="p-4 border rounded-4" style={{
            ...
            <p className="mb-0 text-secondary">
              ...
              พร้อมพัฒ��าอย่างต่อเนื่องเพื่อรองรับอนาคตของสื่อออนไลน์
            </p>
          </div>
        </div>
      </div>
